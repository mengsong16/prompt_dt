...
class Encoder(nn.Module):
    def __init__(self, z_dim, hidden_1, hidden_2):
        super().__init__()
        # 784 = 28 * 28 is the image size in MNIST
    ...
    # x is the image patch we condition on
    # y is the image patch we target to reconstruct
...
class CVAE(nn.Module):
    def __init__(self, z_dim, hidden_1, hidden_2, pre_trained_baseline_net):
        ...
        self.prior_net = Encoder(z_dim, hidden_1, hidden_2)  # x --> z
        self.generation_net = Decoder(z_dim, hidden_1, hidden_2) # z | x --> y
        self.recognition_net = Encoder(z_dim, hidden_1, hidden_2) # y | x --> z
